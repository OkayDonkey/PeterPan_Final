			...
			<div class="login" style="right: 165PX;">
				...
				<c:if test="${session.memberId != null }">
					<input type="button" value="로그아웃"
						onclick="location.href='logout.go'">
				</c:if>

			</div>
			<div class="my_info">

				<a href="<%=request.getContextPath()%>/myPage.go"> <img
					src="https://contents.kyobobook.co.kr/resources/fo/images/common/ink/btn_header_my@2x.png">
				</a>
