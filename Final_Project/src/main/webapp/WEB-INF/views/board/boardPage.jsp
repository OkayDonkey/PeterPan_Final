		...
		<p class="boder_header" style="margin-bottom: 20px;">고객센터</p>
			<div class="boder_body">
				<ul  class="snb_list category">
					 <li class="snb_list" style="margin-bottom: 16px;"><a href="#">메인</a></li>
					 
					 <div>
						 <li class="snb_list" style="margin-bottom: 16px;"><a href="#">자주 묻는 질문</a>
							<div>
								 <ul class="snb_list_box">
									 <li class="snb_item"><a href="#">BEST 10</a></li>
