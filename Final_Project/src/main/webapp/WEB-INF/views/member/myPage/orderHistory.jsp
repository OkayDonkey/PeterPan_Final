	...
	<main class="container_wrapper">
		...
		<section class="contents_wrap aside">
	        ...
	        <div class="tbl_prod_wrap type_myroom">
			    <!-- repeat -->
			    <div class="tbl_myorder_inner" data-order-id="O23056337772">
			        <div class="tbl_order_info">
			            <span class="order_date">2023.05.28(O23056337772)</span><!-- 수정 220428 날짜 양식 yyyy.mm.dd 로 수정 -->
				                        ...
				                        <div class="prod_area horizontal">
				                            <div class="prod_thumb_box size_sm">
				                                <a href="javascript:void(0);" class="prod_link">
				                                    <span class="img_box">
				                                        <img src="https://contents.kyobobook.co.kr/sih/fit-in/200x0/pdt/9788937491214.jpg" alt="뉴턴의 아틀리에">
				                                    </span>
				                                </a>
                          						</div>
                          						<div class="prod_info_box size_sm">
												<a href="javascript:void(0);" class="prod_info">
                                  						<span class="prod_name">[eBook] 뉴턴의 아틀리에</span>
				                                </a>
