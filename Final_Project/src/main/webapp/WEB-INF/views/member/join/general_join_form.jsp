					...
					<form id="join_form" name="f" method="post" onsubmit="return check()" action="<%=request.getContextPath() %>/general_join_ok.go">
						<div class="joinforminsert">
							<div class="form_box">
								...
								<div class="form_cont">
									<input type="text" name="memberId" class="form_ip" id="formJoin01" onkeyup="checkInput(this, 'id')" placeholder="아이디를 입력해 주세요." maxlength="20">
								</div>
							...
							<div class="form_box">
								...
								<div class="form_cont">
									<div class="form_cont">
										<input type="text" name="memberPhone" value="${memberPhone }" readonly class="form_ip" id="formJoin05" onkeyup="checkInput(this, 'phone')" maxlength="11">
									</div>
							...
							<div class="form_box">
								...
								<div class="form_cont">
									<div class="form_cont">
										<input type="text" name="memberEmail" class="form_ip" id="formJoin06" onkeyup="checkInput(this, 'email')" placeholder="이메일을 입력해 주세요." maxlength="50">
									</div>
