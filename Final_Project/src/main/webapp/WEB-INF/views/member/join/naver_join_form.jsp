		...
		<main class="container_wrapper">
			<div class="join_contents_wrap">
				...
				<div class="form_wrap">
					...
					<input type="hidden" name="memberPhone" value="${SNSPhone }">
						...
						<div class="joinforminsert">
							<div class="form_box">
								...
								<div class="form_cont">
									<input type="text" name="memberName" value="${SNSNickname }" readonly class="form_ip" id="formJoin04" onkeyup="checkInput(this, 'name')" placeholder="이름을 입력해 주세요." maxlength="20">
								</div>
							...
							<div class="form_box">
								...
								<div class="form_cont">
									<div class="input_btn_box">
										<input type="text" name="memberBirth" readonly value="${birth }" class="form_ip" id="formJoin07" onkeyup="checkInput(this, 'birth')" placeholder="생년월일 8자리를 입력해 주세요." maxlength="8">
